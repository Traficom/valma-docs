...
2. Alueellisten osamallien lähtökysyntämatriisien zip. -kansiot tulee purkaa. Pura tarvitsemasi kansiot Matrices-nimiseen kansioon niin, että Matrices-kansion alla on kansio(ita) nimetty alueellisen osamallin mukaan
